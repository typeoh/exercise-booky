...
[
  ...
  it(scenario.it, () => {
    ...
    expect(wrapper.find(Genres).exists()).to.equal(existsPage("genres"));
    expect(wrapper.find(GenresHome).exists()).to.equal(
      existsPage("genresHome")
    );
    expect(wrapper.find(RomanceHome).exists()).to.equal(
      existsPage("romanceHome")
    );
    expect(wrapper.find(DramaHome).exists()).to.equal(existsPage("dramaHome"));
